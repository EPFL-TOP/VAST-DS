...
plt.xlabel("Number of somites")
plt.ylabel("Frequency")
plt.text(15, 0.175, r'mean tot   = {:.1f}'.format(np.mean(np.array(n_total_notv))), fontsize=15)
plt.text(15, 0.150, r'median tot = {:.1f}'.format(np.median(np.array(n_total_notv))), fontsize=15)
plt.text(15, 0.125, r'std tot    = {:.1f}'.format(np.std(np.array(n_total_notv))), fontsize=15)
