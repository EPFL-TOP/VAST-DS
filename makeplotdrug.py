...
plt.text(23, 1.2, r'mean tot   = {:.1f}'.format(np.mean(np.array(n_total))), fontsize=15)
plt.text(23, 1.0, r'median tot = {:.1f}'.format(np.median(np.array(n_total))), fontsize=15)
plt.text(23, 0.8, r'std tot    = {:.1f}'.format(np.std(np.array(n_total))), fontsize=15)
